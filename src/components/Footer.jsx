...
const Footer = () => {
    return (
        <div className="flex mb-20">
            <div className={`bg-gradient-to-r from-[#FF3503] to-yellow-500 shadow p-4`}>
                <div className="flex flex-col md:flex-row">

                    <div className="md:w-1/2 mx-auto flex flex-col items-start justify-center p-4 mb-4 md:mb-0 md:ml-10">
