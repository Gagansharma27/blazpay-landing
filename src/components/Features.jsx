...
const Features = () => {
    return (
        <div className="p-8 flex flex-col md:flex-row justify-center space-y-4 md:space-x-4 md:space-y-0">
            ...
            {/* First Red Card */}
            <div style={{ backgroundColor: '#FF3503' }} className="shadow-md min-w-[250px] rounded-md pt-9 px-5 sm:w-full md:w-1/5 flex justify-center items-center">
                <div className="space-y-4">
                    <div className="text-4xl font-semibold text-white">Personalised Usernames</div>
                    <div className="text-white font text-sm">
                        Forget sharing the long string of characters. Just share your Username
                        to receive payments
                    </div>
                    <div style={{ backgroundColor: '#D9D9D9' }} className="p-5 rounded-tl-md rounded-tr-md space-y-6">
            ...
            <div className="flex flex-col space-y-4 sm:w-full md:w-1/4">
                {/* First Gray Card */}

                <div style={{ backgroundColor: '#525B61' }} className="shadow-md rounded-md flex flex-col min-w-[200px] sm:w-full">
                    ...
                    <div className="flex flex-row items-center mt-4">
                        ...
                        <div className="flex flex-col justify-start items-end w-1/2 pl-3 pr-3 pt-1">
                            <div className="text-white text-sm pb-3">
                                Blazpay provides a seamless integration with merchant APIs, making payment processing effortless for businesses.
                            </div>
                        </div>
                    </div>
                ...
                {/* Second Gray Card */}
                <div style={{ backgroundColor: '#E1E1E1' }} className="shadow-md rounded-md p-3 min-w-[250px] sm:w-full space-y-4">
                    <div className="flex flex-row md:flex-row space-y-4 md:space-y-1 md:space-x-0 items-center">
                        <div className="space-y-2 md:space-y-1">
                            ...
                            <div className="text-sm text-black">
                                For businesses that operate offline, Blazpay offers POS Point of Sale machines and cards.
                            </div>
                        </div>
                        <div className="w-2/3 flex-shrink-0">
                            <img src={PosImage} alt="POS Graphic" className="w-full h-auto" />
                        </div>
                    </div>
                </div>
            ...
            {/* Second Red Card */}
            <div style={{ backgroundColor: '#FF3503' }} className="shadow-md rounded-md p-4 min-w-[250px] sm:w-full md:w-1/5 space-y-4 flex justify-center items-center">
                <div className="space-y-4">
                    <div className="text-4xl font-semibold text-white">Easy Payments</div>
