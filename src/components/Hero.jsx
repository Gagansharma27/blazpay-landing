    ...
    <>
      <div className="mt-8 md:bg-hero-pattern bg-cover">
        <div className="justify-between px-4  md:mx-auto lg:max-w-7xl md:flex md:px-8 font-bvmp pb-20">
          ...
          <div className="  rounded-tl-2xl rounded-bl-2xl rounded-br-[50%] md:w-[42%]  mt-8 md:mt-0 bg-gradient-to-t from-[#110C09]/50 to-[#8E8C8C]/25  ">
            <div className="b1 relative">
              <img src={mobile1} alt="mobile1" />
              <img
                src={mobile2}
                alt="mobile2"
                className="absolute top-48 left-11 md:left-48 "
              />
            </div>
          </div>
        </div>
